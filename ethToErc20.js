...
// This function swaps ETH for USDC on Uniswap
// Can be modified to swap to any ERC20


// priceMonitor function at the end calls monitorPrice function
// monitorPrice function calls checkBalances and sellEth functions
...
web3.eth.transactionConfirmationBlocks = 1; // prevents ganache from trying to confirm over default number of blocks

// Account to Use (must hold ETH to start)
ethOwnerAcct = process.env.ACCOUNT
primaryAcct = process.env.ACCOUNT
...
exchangeContract.transactionConfirmationBlocks = 1; // prevents ganache from trying to confirm over default number of blocks

// USER INPUT: Amount ETH to swap
const ETH_AMOUNT = web3.utils.toWei('10', 'Ether') //Update '10' as needed
...
async function checkBalances() {
  ...
  // Check Ether balance
  balance = await web3.eth.getBalance(primaryAcct)
  balance = web3.utils.fromWei(balance.toString(), 'Ether')
  console.log("Ether Balance:", balance)

  // Check erc20 balance
  balance = await erc20Contract.methods.balanceOf(primaryAcct).call()
